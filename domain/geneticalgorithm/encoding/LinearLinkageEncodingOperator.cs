...
public sealed class LinearLinkageEncodingOperator
{
    ...
    public static LinearLinkageEncoding UpdateIntegerGenes(List<Module> modules, LinearLinkageEncoding encoding)
    {
        throw new NotImplementedException("UpdateIntegerGenes method is not implemented yet.");
    }
